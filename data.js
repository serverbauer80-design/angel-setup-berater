...
const AKTUELL = {
  ...
  setup2: {
    ...
    vorfach: "Daiwa J-Fluoro Carbon 0,200 mm (Standard/feiner Köder) oder 0,218 mm · Großforelle/Put&Take: 0,298 mm",
  ...
  setup3: {
    ...
    vorfach: "Daiwa J-Fluoro Carbon 0,200 mm oder 0,218 mm · ca. 1,5–2,5 m Länge",
  ...
  setup4: {
    ...
    vorfach: "Daiwa J-Fluoro Carbon 0,200 mm (Barsch/fein) oder 0,218 mm · ca. 40–80 cm",
    extra: "",
  ...
  setup5: {
    ...
    vorfach: "Daiwa J-Fluoro Carbon 0,200 mm oder 0,218 mm (Brasse/Rotauge/Schleie), 0,298 mm für Karpfen",
  ...
  setup10: {
    ...
    vorfach: "Daiwa J-Fluoro Carbon 0,298 mm · 5,83 kg (Karpfen/Aal)",
...
const SPOTS_SEED = [
  ...
  { name:'Arrild Fiskesø', type:'forellensee', region:'dk', lat:55.1516, lng:8.9616, price:32.00, notes:'Großforellen, Bachforellen | Fly-Fishing-Flussstrecke, Spitzenanlage | Position ungefähr, vor Anfahrt prüfen | arrild-fiskesoe.dk' },
  { name:'Rødekro Fiskepark', type:'forellensee', region:'dk', lat:55.0696, lng:9.341, price:30.00, notes:'Regenbogenforelle, Lachsforelle | 5 Seen auf 60 ha, sehr große Forellen | Position ungefähr, vor Anfahrt prüfen | rodekro-fiskepark.dk' },
  { name:'Mjøls Lystfiskersø', type:'forellensee', region:'dk', lat:55.0696, lng:9.341, price:28.00, notes:'Regenbogenforelle, Goldforelle, Saibling | 3 verbundene Seen | Position ungefähr, vor Anfahrt prüfen | mjoels.dk' },
  { name:'Tinglev Sønderby Put & Take', type:'forellensee', region:'dk', lat:54.9316, lng:9.2482, price:26.00, notes:'Regenbogenforelle, Bachforelle | Dicht an der Grenze (Krusau) | Position ungefähr, vor Anfahrt prüfen | dansee.dk' },
  { name:'Oxriver Put & Take', type:'forellensee', region:'dk', lat:56.1121, lng:8.3179, price:35.00, notes:'Regenbogenforelle, Lachsforelle, Saibling | Künstlich angelegter Flusslauf, West-Jütland | Position ungefähr, vor Anfahrt prüfen | oxriver.dk' },
  { name:'Uge Lystfiskeri & Camping', type:'forellensee', region:'dk', lat:55.02, lng:9.30, price:30.00, notes:'Regenbogenforelle ab 800g | 3 Seen, 24h geöffnet, ganzjährig | nahe Aabenraa | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Rens Fiskesø', type:'forellensee', region:'dk', lat:54.95, lng:9.15, price:28.00, notes:'Regenbogenforelle | Zwischen Tinglev und Tønder | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Terkelsbøl Lystfiskeri & Camping', type:'forellensee', region:'dk', lat:54.98, lng:9.27, price:28.00, notes:'Regenbogenforelle | Blick über die Marsch, nahe Tinglev | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Vrøgum Fiskesø', type:'forellensee', region:'dk', lat:55.62, lng:8.28, price:28.00, notes:'Regenbogenforelle | Bei Oksbøl, Südwest-Jütland | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Storkesøen Ribe', type:'forellensee', region:'dk', lat:55.33, lng:8.77, price:30.00, notes:'Regenbogenforelle | Vollausgestattete Anlage bei Ribe | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Nebel Sø Put & Take', type:'forellensee', region:'dk', lat:55.45, lng:8.55, price:28.00, notes:'Regenbogenforelle | Zwei verbundene Seen bei Esbjerg | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Foldingbro Camping und Fiskesø', type:'forellensee', region:'dk', lat:55.45, lng:9.05, price:26.00, notes:'Regenbogenforelle | Mit Campingplatz, nahe Vejen | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Frueskov Lystfiskersø', type:'forellensee', region:'dk', lat:54.87, lng:9.55, price:28.00, notes:'Regenbogenforelle | Nahe der Flensburger Förde | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Hygge Lake Put and Take', type:'forellensee', region:'dk', lat:55.25, lng:9.50, price:28.00, notes:'Regenbogenforelle 0,8-2,5 kg | Bei Haderslev | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Bjerrely Fiskesø', type:'forellensee', region:'dk', lat:56.13, lng:8.97, price:30.00, notes:'Regenbogenforelle | Bei Herning, mit Muschelhaus | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Tusaagaard Put & Take', type:'forellensee', region:'dk', lat:56.31, lng:9.15, price:30.00, notes:'Regenbogenforelle | Im Karup-Å-Tal | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Blue Rock Fiskepark', type:'forellensee', region:'dk', lat:55.05, lng:10.35, price:35.00, notes:'Regenbogenforelle, Stör, Großkarpfen | Dänemarks größter Fiskepark, Ravnegårdsvej 16, Vester Skerninge (Fyn) | Position ungefähr, vor Anfahrt prüfen | bluerock.dk' },
  { name:'Store Rosenbusk Put and Take', type:'forellensee', region:'dk', lat:55.83, lng:12.35, price:32.00, notes:'Regenbogenforelle | Nordsjælland, Uggeløse Skovvej 9, Lynge, 20 Min. von Kopenhagen | Position ungefähr, vor Anfahrt prüfen | storerosenbusk.dk' },
  { name:'Hvide Sande Slusen', type:'kueste', region:'dk', lat:56.0011, lng:8.1281, price:0, notes:'Meerforelle, Hering, Dorsch, Hornhecht, Aal | Schleuse zwischen Ringkøbing Fjord und Nordsee, Top-Spot v. a. April/Mai (Heringszug) | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Hvide Sande Molen (Süd-/Nordmole)', type:'kueste', region:'dk', lat:55.995, lng:8.13, price:0, notes:'Meerforelle, Dorsch, Platfisch, Hering, Makrele, Aal | Südmole ca. 700m lang, sehr bekannter Molen-Spot | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Blåvand / Hvidbjerg Strand', type:'kueste', region:'dk', lat:55.56, lng:8.12, price:0, notes:'Wolfsbarsch (v. a. nachts), Platfisch (Scholle bis Steinbutt) | Klassischer Brandungsangel-Strand | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Søndervig Strand', type:'kueste', region:'dk', lat:56.09, lng:8.15, price:0, notes:'Platfisch (steigende Fänge letzte Jahre), Wolfsbarsch | Brandungsangeln | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Skjern Å (Mündung Ringkøbing Fjord)', type:'fluss', region:'dk', lat:55.94, lng:8.35, price:0, notes:'Meerforelle, Lachs | Dänemarks bekanntester Meerforellen-/Lachsfluss, mündet in den Ringkøbing Fjord | Position ungefähr, vor Anfahrt prüfen' },
  // Zusätzliche Put & Take-Seen direkt in der Zielregion (Ringkøbing–Skjern–Nørre Nebel–Henne–Oksbøl–Ho),
  // vom Nutzer per Google-Maps-Screenshot geliefert. Koordinaten anhand der sichtbaren Ortsnähe geschätzt.
  { name:'Lodbjerg Hede Ørredsø', type:'forellensee', region:'dk', lat:56.16, lng:8.20, price:28.00, notes:'Regenbogenforelle | Nördlich von Ringkøbing | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Søndervig Put & Take', type:'forellensee', region:'dk', lat:56.09, lng:8.16, price:28.00, notes:'Regenbogenforelle | Direkt bei Søndervig, eigener Teich (nicht der Strand) | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Stauning Havn Fiskesø (Put & Take)', type:'forellensee', region:'dk', lat:55.94, lng:8.35, price:28.00, notes:'Regenbogenforelle | Am Hafen Stauning, Südufer Ringkøbing Fjord | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Stauning Fiskesø', type:'forellensee', region:'dk', lat:55.93, lng:8.34, price:26.00, notes:'Regenbogenforelle | Bei Stauning | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Vestjyllands Put and Take', type:'forellensee', region:'dk', lat:55.98, lng:8.83, price:28.00, notes:'Regenbogenforelle | Östlich von Skjern/Tarm, Richtung Herning | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Hemmet Fiskesø v/Bent Jeppesen', type:'forellensee', region:'dk', lat:55.87, lng:8.36, price:26.00, notes:'Regenbogenforelle | Bei Hemmet, südlich von Skjern | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Nørre Nebel Fiskesø', type:'forellensee', region:'dk', lat:55.78, lng:8.28, price:26.00, notes:'Regenbogenforelle | Bei Nørre Nebel | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Kløvergaardens Put And Take', type:'forellensee', region:'dk', lat:55.76, lng:8.27, price:26.00, notes:'Regenbogenforelle | Nahe Nørre Nebel | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Henne Put and Take', type:'forellensee', region:'dk', lat:55.80, lng:8.20, price:28.00, notes:'Regenbogenforelle | Bei Henne / Henne Strand | Position ungefähr, vor Anfahrt prüfen' },
  { name:'The Fishing Lake at Hebo', type:'forellensee', region:'dk', lat:55.62, lng:8.55, price:26.00, notes:'Regenbogenforelle | Bei Hebo/Næsbjerg, zwischen Oksbøl und Varde | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Grærup Fiskesø', type:'forellensee', region:'dk', lat:55.72, lng:8.15, price:26.00, notes:'Regenbogenforelle | Bei Grærup Strand | Position ungefähr, vor Anfahrt prüfen' },
  { name:'Ho Fiskesø og Minigolf', type:'forellensee', region:'dk', lat:55.50, lng:8.28, price:24.00, notes:'Regenbogenforelle | Bei Ho, südlich von Oksbøl, mit Minigolf | Position ungefähr, vor Anfahrt prüfen' },
